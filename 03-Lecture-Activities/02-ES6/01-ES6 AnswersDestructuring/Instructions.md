...
- Your code should result in a greeting string that dynamically includes the provided name and age variables. For example, const greeting = Hello, my name is ${name} and I am ${age} years old.; should yield greeting containing 'Hello, my name is Alice and I am 25 years old.'.